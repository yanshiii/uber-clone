    ...
    <div className='py-5 px-5 h-screen flex flex-col justify-between'>
      <div>
        ...
        <form onSubmit={submitHandler}>
          ...
          <input required className='bg-[#eeeeee] mb-7 rounded-lg px-4 py-2 border w-full text-lg' value={password} onChange={(e) => setPassword(e.target.value)} type="password" placeholder='password' />
